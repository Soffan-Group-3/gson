...
public final class JsonReaderTest {
	static HashMap<Integer, Boolean> coverage = new HashMap<>();
	...
	public void testReaderDoesNotTreatU2028U2029AsNewline() throws IOException {
		...
		coverage.putAll(readerValid.coverageCheck);
		coverage.putAll(readerInvalid2028.coverageCheck);
		coverage.putAll(readerValid2028And2029.coverageCheck);
	}
	...
	public void testTopLevelValueTypes() throws IOException {
		...
		coverage.putAll(reader1.coverageCheck);
		coverage.putAll(reader2.coverageCheck);
		coverage.putAll(reader3.coverageCheck);
		coverage.putAll(reader4.coverageCheck);
		coverage.putAll(reader5.coverageCheck);
		coverage.putAll(reader6.coverageCheck);
	}
